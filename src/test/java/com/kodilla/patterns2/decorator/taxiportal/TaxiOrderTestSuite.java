...
public class TaxiOrderTestSuite {
    ...
    public void testUberWithTwoChildSeatsGetDescription() {
        ...
        //Then
        assertEquals("Drive a course by Uber. + child seat + child seat", description);
    }

    @Test
    public void testVipTaxiWithChildSeatVipGetCost() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();
        theOrder = new TaxiNetworkOrderDecorator(theOrder);
    ...
    @Test
    public void testVipTaxiWithChildSeatVipGetDescription() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();
        theOrder = new TaxiNetworkOrderDecorator(theOrder);
        theOrder = new VipDecorator(theOrder);
        ...
        //Then
        assertEquals("Drive a course by Taxi Network. + VIP service + child seat", description);
    }
}